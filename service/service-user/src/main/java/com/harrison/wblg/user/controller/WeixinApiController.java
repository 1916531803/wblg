package com.harrison.wblg.user.controller;
...
import com.harrison.wblg.common.result.Result;
import com.harrison.wblg.common.result.ResultCodeEnum;
import com.harrison.wblg.enums.UserType;
import com.harrison.wblg.enums.user.User;
import com.harrison.wblg.common.utils.JwtHelper;
import com.harrison.wblg.user.service.UserService;
import com.harrison.wblg.user.utils.ConstantPropertiesUtil;
import com.harrison.wblg.user.utils.HttpClientUtils;
import com.harrison.wblg.vo.user.LeaderAddressVo;
import com.harrison.wblg.vo.user.UserLoginVo;
...
public class WeixinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        try {
            ...
            throw new WblgException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
